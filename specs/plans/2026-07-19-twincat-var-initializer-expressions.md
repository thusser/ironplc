...
**Status: implemented and landed on this branch.** `d2r : LREAL := PI/180.0;`
now compiles and runs correctly under `--allow-math-constants
...
- [x] All tests from Testing Strategy, plus regression tests for the two
      ...
      disambiguation)
- [x] PI (`2026-07-19-twincat-pi-constant.md`) already landed separately;
      added combined tests proving `d2r : LREAL := PI/180.0;` now resolves
      end-to-end with both flags enabled
- [x] Update docs
