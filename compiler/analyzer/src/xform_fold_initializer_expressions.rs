...
//! (e.g. `d2r : LREAL := PI/180.0;`). The parser accepts this broader form
//! unconditionally, producing `InitialValueAssignmentKind::SimpleExpr` — a
//! placeholder that this pass always normalizes away before any other
//! semantic pass runs:
//!
